...
## E-commerce Data Platform (Assignment)
...
### Optional (for cloud / BI targets)

- **Databricks workspace** + `uv sync --extra cloud` (installs dbt-databricks + dbt-postgres adapters)
- **Power BI Desktop** + DuckDB ODBC driver (for BI consumption)
...
### Power BI prerequisites (local mode)
